...
class AbonnementController extends Controller
{
    ...
    {
        return view('layout.abonnement.index');
    }
    ...
    {
        return view('layout.abonnement.selectclient');
    }
    ...
    public function selectcompteur(Request $request)
    {
        ...
        return view('layout.abonnement.selectcompteur', compact('client'));
    }
    ...
    public function create(Request $request)
    {
        ...
        return view('layout.abonnement.create', compact(['client', 'compteur']));
    }
    ...
    public function show(Abonnement $abonnement)
    {
        ...
        return view('layout.abonnement.show', compact(['compteur', 'abonnement']));
    }
